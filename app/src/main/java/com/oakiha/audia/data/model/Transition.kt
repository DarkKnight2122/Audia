...
/**
 * Defines the available transition modes between books.
 */
 ...
 * priority (Booklist-specific rules should override global defaults).
 */
enum class TransitionSource {
    /** Fallback to the global default transition settings. */
    GLOBAL_DEFAULT,

    /** A Booklist-wide default rule. */
    Booklist_DEFAULT,
 ...
 *
 * @param BooklistId The ID of the Booklist this rule applies to.
 * @param fromTrackId The ID of the track to transition from. If null, this is a default rule for the Booklist.
 * @param toTrackId The ID of the track to transition to. If null, this is a default rule for the Booklist.
