...
fun DailyMixMenu(
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            Text(
                text = "Tu Daily Mix se crea a partir de tus canciones favoritas y las que mÃ¡s escuchas. TambiÃ©n aÃ±adimos canciones de artistas y gÃ©neros que te gustan para que descubras nueva mÃºsica.",
            )
