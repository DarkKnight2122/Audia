...
fun PlayingEqIcon(
    ...
    phaseDurationMillis: Int = 2400,   // ciclo mÃ¡s lento
    wanderDurationMillis: Int = 8000,  // patrÃ³n mÃ¡s largo
    gapFraction: Float = 0.30f
) {
    // Driver continuo (sigue corriendo en pausa para preservar el patrÃ³n)
    ...
    // Velocidades ENTERAS â†’ continuidad perfecta en wrap 2Ï€
